...
const Dashboard = () => {
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-gaming font-bold bg-gradient-to-r from-[#1B5E20] to-[#2E7D32] dark:from-primary-500 dark:to-secondary-500 bg-clip-text text-transparent mb-2">Dashboard</h1>
        <p className="text-[#546E7A] dark:text-gray-400">Welcome back! Here's your inventory overview.</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <GlassCard>
          <h3 className="text-xl font-semibold text-[#263238] dark:text-white mb-4">Recent Activity</h3>
        ...
        <GlassCard>
          <h3 className="text-xl font-semibold text-[#263238] dark:text-white mb-4">Low Stock Alert</h3>
          <div className="space-y-3">
