            ...
            {showApprovalMessage ? (
                ...
                >
                  ...
                  <div className="flex items-center justify-center gap-2 mb-2">
                    ...
                    <div className="flex items-center gap-1">
                      <div className="w-6 h-6 rounded-full bg-emerald-500 text-white flex items-center justify-center text-xs font-bold">✓</div>
                      <span className="text-xs text-emerald-600 dark:text-emerald-400 font-medium">Verify</span>
                    </div>
                    ...
                    <div className="flex items-center gap-1">
                      ...
                      <span className="text-xs text-amber-600 dark:text-amber-400 font-medium">Approval</span>
                    </div>
                  </div>
                  ...
                  <div className="text-center space-y-4">
                    ...
                    <h2 className="text-2xl font-bold text-gray-800 dark:text-white">Email Verified! 🎉</h2>
                    ...
                    <div className="bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-700 rounded-xl p-4 space-y-3">
                      ...
                      <p className="text-sm text-amber-700 dark:text-amber-300">
                        Your account has been created and email verified. An administrator will review and approve your account shortly.
                      </p>
                    </div>
                  ...
                  <button
                      ...
                      onClick={() => {
                        ...
                        setIsRegister(false);
                        setEmailOrUsername(name);
                      }}
                      className="w-full py-3 px-4 rounded-xl font-semibold text-white text-lg shadow-lg transition-all duration-300 flex items-center justify-center gap-2 bg-gradient-to-r from-blue-500 to-indigo-500 hover:from-blue-600 hover:to-indigo-600 hover:shadow-xl transform hover:-translate-y-0.5"
                  >
                ...
                >
                  ...
                  <div className="flex items-center justify-center gap-2 mb-2">
                    ...
                    <div className="flex items-center gap-1">
                      ...
                      <span className="text-xs text-gray-400 font-medium">Approval</span>
                    </div>
                  </div>
                  ...
                  <div className="text-center space-y-2">
                    ...
                    <h2 className="text-xl font-semibold text-gray-800 dark:text-white">Admin Verification Required</h2>
                    <p className="text-sm text-gray-600 dark:text-gray-400">
                      A 6-digit verification code has been sent to the admin
                    </p>
                    <p className="text-sm font-medium text-emerald-600 dark:text-emerald-400 bg-emerald-50 dark:bg-emerald-900/30 px-3 py-1 rounded-full inline-block">
                      📧 {ADMIN_EMAIL}
                    </p>
                    <p className="text-xs text-gray-500 dark:text-gray-400 mt-2">
                      Please contact admin to get the verification code
                    </p>
                  </div>

                  {/* User's registered email info */}
                  <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-700 rounded-lg px-3 py-2">
                    <p className="text-xs text-blue-700 dark:text-blue-300 text-center">
                      Your registered email: <span className="font-semibold">{pendingEmail}</span>
                    </p>
                  </div>
                  ...
                  <div className="space-y-2">
                    <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 text-center">
                      Enter Verification Code from Admin
                    </label>
