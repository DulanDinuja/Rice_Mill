...
const Reports = () => {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-gaming font-bold text-white mb-2">Reports</h1>
        <p className="text-gray-400">Analytics and insights</p>
      </div>

      <GlassCard>
        <h3 className="text-xl font-semibold text-white mb-6">Stock Movement (Last 6 Months)</h3>
        <ResponsiveContainer width="100%" height={400}>
          <BarChart data={data}>
            ...
            />
            <Bar dataKey="rice" fill="#00FF88" />
            <Bar dataKey="paddy" fill="#8A2BE2" />
          </BarChart>
        </ResponsiveContainer>
      </GlassCard>
    </div>
