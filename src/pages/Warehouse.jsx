          ...
          <GlassCard key={warehouse.id}>
            <div className="space-y-4">
              <div className="flex items-start justify-between">
                <div>
                  <h3 className="text-xl font-semibold text-gray-900 dark:text-white">{warehouse.name}</h3>
                  <p className="text-gray-600 dark:text-gray-400 text-sm">{warehouse.location}</p>
                </div>
              ...
              <div className="space-y-2">
                ...
                <div className="flex justify-between text-sm">
                  ...
                  <span className="text-gray-900 dark:text-white font-medium">{warehouse.capacity} kg</span>
                </div>
              </div>
